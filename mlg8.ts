...
<body>
    <div id="container">
        ...
        <img id="earImage" src="images/ear.png" style="display:none;" />
    ...
    <script>
        ...
        const earImg = document.getElementById('earImage');
        ...
        function processBodyPart(image, startX, startY, partName, centroidsArray) {
        ...
        function render() {
            ...
            ctx.drawImage(earImg, 0, 0);
            processBodyPart(earImg, 0, 0, 'Ear', earCentroids);
        ...
        function loadImages() {
            const images = [bodyImg, earImg, headImg];
            let loadedImages = 0;
            ...
            images.forEach(img => {
                img.onload = () => {
                    ...
                    if (loadedImages === images.length) {
                        const maxWidth = Math.max(bodyImg.width, earImg.width, headImg.width);
                        const maxHeight = Math.max(bodyImg.height, earImg.height, headImg.height);
